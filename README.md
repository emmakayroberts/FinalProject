...
### From here on out, for conversion between file formats (phylip, fasta, nexus) a file converter was used: http://phylogeny.lirmm.fr/phylo_cgi/data_converter.cgi 

# Distance and Parsimony 
02Mar2023
## Ape and Phangorn Software Description
